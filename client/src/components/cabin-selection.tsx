          ...
          <div className="mb-8">
            ...
            <RadioGroup value={locationPreference} onValueChange={setLocationPreference}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <RadioGroupItem value="guarantee" id="guarantee" className="text-ocean-600" data-testid="radio-guarantee" />
                  <div className="ml-3">
                    <div className="font-medium text-gray-900">Guarantee Cabin</div>
                    <div className="text-sm text-gray-600">Best price, random location assignment</div>
                  </div>
                </Label>
                <Label 
                  htmlFor="choose"
                  className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-ocean-300 transition-colors"
                >
                  <RadioGroupItem value="choose" id="choose" className="text-ocean-600" data-testid="radio-choose" />
                  <div className="ml-3">
                    <div className="font-medium text-gray-900">Choose Location</div>
                    <div className="text-sm text-gray-600">Select specific deck and position (+$50)</div>
                  </div>
                </Label>
              </div>
            </RadioGroup>
