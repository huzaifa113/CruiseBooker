...
export default function CruiseCard({
  ...
  const {
    data: cabinTypes,
    isLoading: cabinTypesLoading,
    error: cabinTypesError,
  } = useQuery({
    ...
    return (
      <>
        <Card
          ...
          data-testid={`cruise-card-${cruise.id}`}
        >
          ...
          <CardContent className="p-6">
            <div className="flex items-center mb-3">
              ...
              <div>
                <h3
                  ...
                  data-testid={`text-cruise-name-${cruise.id}`}
                >
                  {cruise.name}
                </h3>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center text-sm text-gray-600">
                ...
                <span data-testid={`text-duration-${cruise.id}`}>
                  {cruise.duration} {t('days')} / {cruise.duration - 1} {t('nights')}
                </span>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <span
                    ...
                    data-testid={`text-price-${cruise.id}`}
                  >
                    {formatPrice(cruise.basePrice)}
                  </span>
                  <p className="text-xs text-gray-600">{t('perPerson')}</p>
                </div>
              </div>
        ...
        <div className="flex flex-col md:flex-row">
          <div className="relative md:w-2/5 min-h-[200px] md:min-h-[280px]">
            ...
            <div className="absolute top-4 right-4">
              <Badge
                variant="secondary"
                className="bg-white bg-opacity-90 text-gray-800 text-xs px-2 py-1"
              >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600" data-testid={`text-ship-name-${cruise.id}`}>
                      {cruise.ship}
                    </p>
                  </div>
                </div>
                <div className="flex items-center text-sm text-gray-600 mb-2">
                  ...
                  <span data-testid={`text-departure-date-${cruise.id}`}>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-gray-600 mb-2">
                  {t('perPerson')}, {t('from')} {t('cabinTypes.interior')}
                </p>
                <Button
