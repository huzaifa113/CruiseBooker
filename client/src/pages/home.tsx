...
export default function Home() {
  ...
  const { setSelectedDeal, clearSelectedDeal } = useDeals();
  ...
  const handleSelectCruise = (cruise: Cruise) => {
    // Clear any selected deal when selecting from featured cruises (not deals section)
    clearSelectedDeal();
  ...
  const handleBookCruise = (cruise: Cruise) => {
    ...
    // Clear any selected deal when booking from featured cruises (not deals section)
    clearSelectedDeal();
    setLocation(`/booking/${cruise.id}`);
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {error && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {t('unableToLoadCruises')}
              </h3>
              <p className="text-gray-600 mb-4">{t('technicalDifficulties')}</p>
            </div>
          )}
          ...
          {cruises && cruises.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('noFeaturedCruises')}</h3>
      ...
      <section className="py-16 bg-gradient-to-r from-green-50 to-emerald-50" id="deals-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">{t('specialDealsSubtitle')}</p>
          </div>
                ...
                return (
                  ...
                  >
                    <CardContent className="p-6 flex flex-col h-full">
                      <div
                        className={`absolute top-4 right-4 ${colorClass} text-white px-3 py-1 rounded-full text-sm font-bold whitespace-nowrap z-10`}
                      >
                        {discountText}
                      </div>
                      <h3
                        className="text-xl font-bold text-gray-900 mb-2 pr-16"
                        data-testid={`deal-title-${promotion.id}`}
                      >
                        {promotion.name}
                      </h3>
                      <p
                        className="text-gray-600 mb-4 flex-1"
                        data-testid={`deal-description-${promotion.id}`}
                      >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">{t('whyChooseUsSubtitle')}</p>
          </div>
                  ...
                  <div className="relative h-48">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        if (!target.src.includes('auto=compress')) {
                          target.src =
                            destination.image + '&auto=compress&cs=tinysrgb&dpr=2&h=650&w=940';
                        } else {
                    ...
                    <div className="absolute bottom-4 left-4 text-white">
                      ...
                      <p className="text-xs mt-1 text-blue-200">
                        {destination.cruiseCount} cruise{destination.cruiseCount > 1 ? 's' : ''}
                      </p>
                    </div>
                  </div>
                </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="p-8 bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 border-0">
              <CardContent className="p-0">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Our Mediterranean cruise was absolutely spectacular! The staff was incredibly
                  attentive, the ship was immaculate, and every port was a new adventure. Phoenix
                  Vacation Group made our dream vacation come true."
                </p>
            ...
            <Card className="p-8 bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 border-0">
              <CardContent className="p-0">
                ...
                <Quote className="w-8 h-8 text-blue-200 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "The Alaska cruise exceeded all expectations! Watching glaciers calve while
                  enjoying world-class dining was unforgettable. The booking process was seamless
            ...
            <Card className="p-8 bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 border-0">
              <CardContent className="p-0">
                ...
                <Quote className="w-8 h-8 text-blue-200 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "First time cruising and it won't be our last! Phoenix made everything so easy
                  from booking to boarding. The staff went above and beyond to make our honeymoon
                  special. Thank you for the perfect start to our marriage!"
                </p>
                <div className="flex items-center">
                  <Avatar className="w-12 h-12 mr-4">
                    <AvatarImage
            ...
            <Card className="p-8 bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 border-0">
              <CardContent className="p-0">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  ...
                  entertainment was top-notch, and our suite was absolutely perfect. Phoenix
                  Vacation Group delivers on their promise of luxury experiences."
                </p>
                <div className="flex items-center">
                  <Avatar className="w-12 h-12 mr-4">
                    <AvatarImage
